...
def placeOna(icApi,name,x,y, inputs, nmbrofpoints, startWavelength, stopWavelength):
    '''
    ...
    :return:
    '''
    print('The required Optical Network Analyzer was placed successfully')
    ...
    icApi.set('start frequency', c/startWavelength)
    icApi.set('stop frequency', c/stopWavelength)
